...
async function testDealerTrackAutomation() {
  ...
  // Launch browser with specific headless configuration for servers without displays
  const browser = await puppeteer.launch({
    ...
    args: [
      ...
      '--disable-gpu',
      '--disable-features=VizDisplayCompositor', // Disable compositing which requires a display
      '--disable-extensions',
